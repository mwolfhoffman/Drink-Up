    ...
    function BeerController($Beer, $List, $stateParams) {
        ...
        bc.$onInit = function () {
            $Beer.getBeerById($stateParams.id, (data) => {
                ...
                bc.abv = data.data.data.abv ?
                    data.data.data.abv : `N/A`

                bc.ibu = data.data.data.ibu ?
                    data.data.data.ibu : `N/A`

                bc.avail = data.data.data.available ?
                    data.data.data.available.name : 'N/A'

                bc.srm = data.data.data.srm ?
                    data.data.data.srm.name : 'N/A'

                bc.temp = data.data.data.servingTemperatureDisplay
                    ?
                    data.data.data.servingTemperatureDisplay : 'N/A, but probably cold'

                bc.glass = data.data.data.glass ?
                    data.data.data.glass.name : 'N/A'
            })
        }
